...
namespace info.Models
{
    ...
    public static class CopyReplacment {

        public static void GetCopyKVRegExs(List<KeyValuePair<String, String>> abbr)
        {
            ...
            abbr.Add(new KeyValuePair<string, string>(@"FSH\b", "Fisheries Committee"));
            abbr.Add(new KeyValuePair<string, string>(@"TTP\b", "Special Committee on Taps Throughput"));

            abbr.Add(new KeyValuePair<string, string>(@"MLV\b", "Military & Veterans' Affairs Committee"));
            ...
            abbr.Add(new KeyValuePair<string, string>(@"L&amp[;]C\b", "Labor & Commerce Committee"));
    ...
    public class ItemOverview
    {
        ...
        public string Status
        {
            get
            {
                ...
                CopyReplacment.GetCopyKVRegExs(abbr);
        ...
        public string State
        {
            ...
            {
                string rslt = "";
                if (this.Status.ToString().ToLower().Contains("chapter"))
                {
                    rslt = "Passed";
                }
                else if (this.Status.ToString().ToLower().Contains("resolve"))
                {
                    rslt = "Passed";
                }
                else if (this.Status.ToString().ToLower().Contains("withdrawn"))
                {
                    rslt = "Withdrawn";
                }
                else if (this.LastActivity.HasValue)
                {
                    rslt = "Committee";
                }
    ...
    public class Legislation
    {
            ...
            get
            {
                ...
                foreach (KeyValuePair<string, string> r in abbr.ToList())
                    if (_CurrentStatus != null)
                        _CurrentStatus = Regex.Replace(_CurrentStatus, r.Key, r.Value);
        ...
        public string State
        {
            ...
            {
                string rslt = "";
                if (this.CurrentStatus.ToString().ToLower().Contains("chapter"))
                {
                    rslt = "Passed";
                }
                else if (this.CurrentStatus.ToString().ToLower().Contains("resolve"))
                {
                    rslt = "Passed";
                }
                else if (this.CurrentStatus.ToString().ToLower().Contains("withdrawn"))
                {
                    rslt = "Withdrawn";
                }
                else
